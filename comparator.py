...
def compare(frequencies, huffman_code, shannon_code, shannon_fano_code):
    ...
    print "{:<14} {:<20} {:<18}".format('Huffman', huffman_avg_cw_length, huffman_compression_ratio)
    print "{:<14} {:<20} {:<18}".format('Shannon', shannon_avg_cw_length, shannon_compression_ratio)
    print "{:<14} {:<20} {:<18}".format('Shannon Fano', shannon_fano_avg_cw_length, shannon_fano_compression_ratio)
    print
